...
main(void)
{
  ...
  range   = (fluke8050a_RNG_C<<2)|(fluke8050a_RNG_B<<1)|fluke8050a_RNG_A;
  
  function  = (fluke8050a_FUNC_C<<2)|(fluke8050a_FUNC_B<<1)|(fluke8050a_FUNC_A);
  ...
  ten_thousands =(fluke8050a_DP<<4)|(fluke8050a_W<<3)|(fluke8050a_X<<2)|(fluke8050a_Y<<1)|(fluke8050a_Z);//rel sym bit4, number bits3-0

  hv  = fluke8050a_HV;    //read hv pin at any stobe
  
  while(!fluke8050a_ST1);
  while(fluke8050a_ST1);
  thousands = (fluke8050a_DP<<4)|(fluke8050a_W<<3)|(fluke8050a_X<<2)|(fluke8050a_Y<<1)|(fluke8050a_Z);
  
  while(!fluke8050a_ST2);
  while(fluke8050a_ST2);
  hundreds = (fluke8050a_DP<<4)|(fluke8050a_W<<3)|(fluke8050a_X<<2)|(fluke8050a_Y<<1)|(fluke8050a_Z);
  
  while(!fluke8050a_ST3);
  while(fluke8050a_ST3);
  tens =  (fluke8050a_DP<<4)|(fluke8050a_W<<3)|(fluke8050a_X<<2)|(fluke8050a_Y<<1)|(fluke8050a_Z);
  
  while(!fluke8050a_ST4);
  while(fluke8050a_ST4);
  ones =  (fluke8050a_DP<<4)|(fluke8050a_W<<3)|(fluke8050a_X<<2)|(fluke8050a_Y<<1)|(fluke8050a_Z);

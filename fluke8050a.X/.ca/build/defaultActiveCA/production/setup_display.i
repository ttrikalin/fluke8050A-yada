...
void display_setup(void){
  ...
  display_write_command(0xF7);
  display_write_data(0x20);

  display_write_command(0xEA);
  display_write_data(0x00);
  display_write_data(0x00);
  ...
  display_write_command(0xC1);
  display_write_data(0x11);

  display_write_command(0xC5);
  display_write_data(0x35);
  display_write_data(0x3E);

  display_write_command(0xC7);

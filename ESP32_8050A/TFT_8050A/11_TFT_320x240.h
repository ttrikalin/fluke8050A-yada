...
#define TFT_SCREEN_ROTATION   0

#define CANVAS_WIDTH  (IS_ODD(TFT_SCREEN_ROTATION) ? TFT_HEIGHT : TFT_WIDTH)
#define CANVAS_HEIGHT (IS_ODD(TFT_SCREEN_ROTATION) ? TFT_WIDTH : TFT_HEIGHT)

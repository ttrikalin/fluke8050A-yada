...
#ifndef _MODIFIED_ADAFRUIT_ILI9340H_
#define _MODIFIED_ADAFRUIT_ILI9340H_
...
class Modified_Adafruit_ILI9340 {

 public:

  Modified_Adafruit_ILI9340(uint8_t RS, uint8_t RST);

  void begin(void);
  void setAddrWindow(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1);
  void bmpDraw( const uint8_t * b, uint16_t x, uint16_t y, uint16_t w, uint16_t h,
             uint16_t fg, uint16_t bg = ILI9340_BLUE );
